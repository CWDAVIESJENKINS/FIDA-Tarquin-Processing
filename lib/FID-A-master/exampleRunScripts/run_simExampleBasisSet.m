...
% ************INPUT PARAMETERS**********************************
 lb=2;         %linewidth (Hz)
 np=4134;      %Spectral points
 sw=4000;      %Spectral width (Hz)
 Bo=2.8936;         %Magnetic Field Strength (Tesla)
 te1=34;       %First PRESS echo time, or SPECIAL echo time (ms)
 te2=34;      %Second PRESS echo time (if applicable) (ms).
